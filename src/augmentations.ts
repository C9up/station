 ...
 *
 * Loaded from the package barrel, so importing Station anywhere in the
...
declare module "@c9up/ream/types" {
	interface ContainerBindings {
		/** The admin resource registry, bound by `StationProvider`. */
		station: ResourceRegistry;
	}
}
